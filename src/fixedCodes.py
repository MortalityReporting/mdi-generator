...
code_MannerOfDeath = { "system": "http://loinc.org", "code": "69449-7", "display": "Manner of death" }
code_TobaccoUseContributedToDeath = { "system": "http://loinc.org", "code": "69443-0", "display": "Did tobacco use contribute to death" }

# Components
code_IntervalComponent = { "system" : "http://loinc.org", "code" : "69440-6", "display" : "Disease onset to death interval" }
code_PronouncedDeadComponent = { "system" : "http://loinc.org", "code" : "80616-6", "display" : "Date and time pronounced dead [US Standard Certificate of Death]"}